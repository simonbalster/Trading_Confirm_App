      ...
      switch (selectedOption) {
        case 'PrevSame':
          return [
            ...
            {
              id: 'rule2',
              description: 'If your H4 candle closed over previous day close wick, the open wick of your H4 same direction MUST also be within the range of the previous same direction DAY.',
              allowNA: true,
              images: [
                {
            ...
            {
              id: 'rule5',
              description: 'Current opposite day CAN NOT be LQW at H/L of your H4 candle.',
              allowNA: true,
              images: [
                {
            ...
            {
              id: 'rule6',
              description: 'Current opposite day CAN NOT be SCMSB after NH/NL over 2x structures at the H/L of your H4 candle.',
              allowNA: true,
              images: [
                {
        ...
        case 'PrevOpp':
          return [
            {
              id: 'rule1',
              description: 'Your H4 same direction candle must close inside the close wick of the daily opposite direction.',
              images: [
                {
