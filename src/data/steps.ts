      ...
      switch (selectedOption) {
        ...
        case 'PrevOpp':
          return [
            {
              id: 'rule1',
              description: `H4 candle must close inside the close wick of the daily opposite direction.
                unless rule below applies`,
              allowNA: true,
              images: [
                {
            ...
            {
              id: 'rule2',
              description: 'If H4 candle closed over previous days OPPOSITE day open wick, the open wick of your H4 opposite candle MUST be within the range of the previous opposite direction candle.',
              allowNA: true,
              images: [
                {
...
• LQW doesnt need to come off/tap the H1 NH/NL level, it just has to be a HL/LH high after it.`,
            ...
            {
              id: 'rule8',
              description: `The H1 NH/NL level before your LQW MUST 
• Close over its most recent structure wick OR at least be the exact same price as most recent structure wick.`,
              images: []
            },
            {
              id: 'rule9',
              description: `The H1 NH/NL level directly before your LQW must 
                • Close/tap into empty space or 
                • NON msb structure.`,
              images: []
            }
          ];
